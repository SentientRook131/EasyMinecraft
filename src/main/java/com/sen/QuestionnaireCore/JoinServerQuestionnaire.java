...
public class JoinServerQuestionnaire extends Questionnaire {
    ...
    public JoinServerQuestionnaire() {
        ...
        addQuestion(new Question(true, QuestionType.CHOICE, "sin 30° 等于", 1, "", "A", new Toolkit<Choice>().createList(new Choice("A", "A. 1/2"), new Choice("B", "B. 钝角")), 10));
        addQuestion(new Question(true, QuestionType.CHOICE, "sin 60° 等于", 2, "", "B", new Toolkit<Choice>().createList(new Choice("A", "A. sqrt(3)/3"), new Choice("B", "B. sqrt(3)/2")), 30));
